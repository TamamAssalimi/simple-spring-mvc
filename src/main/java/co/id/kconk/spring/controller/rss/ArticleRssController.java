package co.id.kconk.spring.controller.rss;
...
public class ArticleRssController {
    ...
    public Channel articleHttpFeed() {
        ...
        item1.setLink("http://www.kconk.co.id/netty-exception-handling");
        ...
        item1.setAuthor("Kconk");

        Article item2 = new Article();
        item2.setLink("http://www.kconk.co.id/cockroachdb-java");
