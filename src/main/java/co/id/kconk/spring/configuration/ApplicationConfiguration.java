...
import co.id.kconk.spring.controller.rss.ArticleRssFeedViewResolver;
import co.id.kconk.spring.controller.rss.JsonChannelHttpMessageConverter;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {  "co.id.kconk.spring" })
